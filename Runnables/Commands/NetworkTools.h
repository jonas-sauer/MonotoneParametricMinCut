...
public:
    ApplyBoundingBox(BasicShell& shell) :
        ...
        addParameter("Intermediate binary");
        addParameter("Bounding box", {"germany", "deutschland", "switzerland", "netherlands", "bw", "badenWuerttemberg", "baden-wuerttemberg", "badenWürttemberg", "baden-württemberg", "bern", "london"});
        addParameter("Output file");
    }
    ...
    virtual void execute() noexcept {
        ...
        if (boundingBox == "germany" || boundingBox == "deutschland") {
            inter.applyBoundingBox(BoundingBoxes::Germany);
        } else if (boundingBox == "switzerland") {
            inter.applyBoundingBox(BoundingBoxes::Switzerland);
        } else if (boundingBox == "netherlands") {
            inter.applyBoundingBox(BoundingBoxes::Netherlands);
        } else if (boundingBox == "bw" || boundingBox == "badenWuerttemberg" || boundingBox == "baden-wuerttemberg" || boundingBox == "badenWürttemberg" || boundingBox == "baden-württemberg") {
            inter.applyBoundingBox(BoundingBoxes::BadenWuerttemberg);
        } else if (boundingBox == "london") {
            inter.applyBoundingBox(BoundingBoxes::London);
        } else if (boundingBox == "bern") {
            inter.applyBoundingBox(BoundingBoxes::Bern);
        }
        inter.printInfo();
        inter.serialize(outputFile);
    }
...
class MakeTransitiveStopGraph : public ParameterizedCommand {

public:
    MakeTransitiveStopGraph(BasicShell& shell) :
        ParameterizedCommand(shell, "makeTransitiveStopGraph", "Makes the stop graph transitive.") {
        addParameter("CSA binary");
        addParameter("Output file");
    }

    virtual void execute() noexcept {
        CSA::Data csa(getParameter("CSA binary"));
        csa.printInfo();
        csa.makeDirectedTransitiveStopGraph(true);
        csa.printInfo();
        csa.serialize(getParameter("Output file"));
    }
