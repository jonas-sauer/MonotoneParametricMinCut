...
#include "../CH/UPQuery/ProfileCSAUPQuery.h"
#include "../CH/UPQuery/ProfileUPQuery.h"
...
template<bool DEBUG, bool USE_TARGET_BUCKETS>
using ProfileCSAInitialAndFinalTransfers = CH::ProfileCSAUPQuery<USE_TARGET_BUCKETS, true, DEBUG>;
