...
public:
    ...
    static const std::vector<std::string> departureBufferTimesFileNameAliases;
...
const std::vector<std::string> Data::departureBufferTimesFileNameAliases{"Boarding-Buffer.csv"};
